...
- Repository for V1: [![DOI:10.5281/zenodo.17791209](https://zenodo.org/badge/1063309544.svg)](https://zenodo.org/records/17791210)  
If you use this tool, please cite both **the software** (see “Cite this repository”) and the corresponding **paper**:

> Gerster, A., Kaestner, K., Knoche, A., Milcetic, M., & Schweers, J. (2025). *How socio-economic factors shape building energy performance: Evidence from the German Housing and Heating Panel* (Unpublished manuscript). RWI – Leibniz Institute for Economic Research.
